        ...
        <FooterBox className="flex-v-center">
            <CompanyInfo className="flex-v-center column">
                ...
                <div className="information-text flex-v-center column">
                    ...
                    <small> 본사주소 : (우)35264 대전광역시 서구 계룡로 599, 102호 | 대표번호 : +82 70-4236-1122</small>
                    <small> 102, 599 Gyeryong-ro, Seo-gu, Daejeon, 35264, Republic of Korea </small>
                    <small> 본 사이트의 컨텐츠는 저작권법의 보호를 받는 바 무단 전재, 복사, 배포 등을 금합니다.</small>
                </div>
